...
import com.csii.utils.Check;
import com.csii.utils.FileUtil;
import com.csii.utils.NetWork;
...
public class AppHttpClient {
    ...
    private Cache cache() {
        final @Nullable File baseDir = FileUtil.getExternalCacheDir(ImanApplication.getContext());
    ...
    private Interceptor cacheInterceptor() {
        return new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetWork.isAvailable(ImanApplication.getContext())) {
